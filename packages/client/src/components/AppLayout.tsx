    ...
    <div className="h-full flex">
      ...
      {showChat && isChatOpen && (
        <ResizableChatPanel
          ...
          className="h-full"
        >
          {/* Chat content placeholder - actual chat components should come from @captify/chat */}
          <div className="p-4 flex items-center justify-center h-full">
            <div className="text-center text-muted-foreground">
              <p>Chat functionality available in @captify/chat package</p>
