...
// Generated at: 2025-08-27T20:28:18.568Z
  ...
  routes: [
    // DynamoDB operations
    {
      ...
      handler: async (req: Request) => {
        const response = await dynamoService.execute(
          req as any,
          {} as any,
          {} as any
        );
    ...
    // S3 operations
    {
      ...
      handler: async (req: Request) => {
        const response = await s3Service.execute(
          req as any,
          {} as any,
          {} as any
        );
    ...
    // Neptune operations
    {
      ...
      handler: async (req: Request) => {
        const response = await neptuneService.execute(
          req as any,
          {} as any,
          {} as any
        );
