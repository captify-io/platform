  ...
  useEffect(() => {
    async function fetchDashboardData() {
      try {
        ...
        const organizations =
          await coreServices.organizations.listOrganizations();

        // Fetch all users
        const allUsers = await coreServices.users.listUsers();
        const activeUsers = await coreServices.users.listUsers({
          status: "active",
        });
        const pendingUsers = await coreServices.users.listUsers({
          status: "pending",
        });
        const suspendedUsers = await coreServices.users.listUsers({
          status: "suspended",
        });

        // Fetch all roles
        const roles = await coreServices.roles.listRoles();
