...
import type { CaptifyApplication } from "@captify-io/core/types";

export default function ApplicationsPage() {
  const [applications, setApplications] = useState<CaptifyApplication[]>([]);
  const [selectedApp, setSelectedApp] = useState<CaptifyApplication | null>(null);
  ...
  const loadApplications = async () => {
    try {
      ...
      if (result.success && result.data?.Items) {
        const apps = result.data.Items as CaptifyApplication[];
