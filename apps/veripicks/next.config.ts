...
const nextConfig = {
  ...
  webpack: (config, { buildId, dev, isServer, defaultLoaders, webpack }) => {
    // Handle @captify/client package resolution
    config.resolve.alias = {
      ...config.resolve.alias,
      "@captify/client": require.resolve("@captify/client"),
    };
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "X-Requested-With, Content-Type, Authorization, X-ID-Token, X-AWS-Session-Token, X-User-Email",
          },
        ],
      },
    ];
  ...
  images: {
    domains: ["a.espncdn.com", "logoeps.com", "assets.vercel.com"],
